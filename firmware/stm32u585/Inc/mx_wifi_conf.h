...
/* SPI2 runs without a DMA channel here, so the driver polls rather than taking a path
 * whose channel nothing configured. */
#define DMA_ON_USE                                  (0)
...
#define WIFI_SSID                                   LAXITY_WIFI_SSID
#define WIFI_PASSWORD                               LAXITY_WIFI_PASSWORD
